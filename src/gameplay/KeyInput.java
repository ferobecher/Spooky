...
/**
*
*trieda na spracovanie klávesových vstupov
*@version 1.0
...
public class KeyInput implements KeyListener {
    ...
    */
    ...
    /**
    *
    *prepísaná metóda, ktorá nerobí ni? ale musí sa tu nachádza?
    *@version 1.0
    *@author František Becher <becherferko@gmail.com>
    *
    */
    ...
    /**
    *
    *prepísaná metóda, ktorá spracuváva stla?enie kláves
    *@version 1.0
    *@author František Becher <becherferko@gmail.com>
    *
    */
    ...
    /**
    *
    *prepísaná metóda, ktorá spracuváva pustenie kláves
    *@version 1.0
    *@author František Becher <becherferko@gmail.com>
    *
    */
    ...
    /**
    *
    *gettery vracajúce potrebné premenné inštancie pre ?alšie použitie
    *@version 1.0
    *@author František Becher <becherferko@gmail.com>
    *
    */
